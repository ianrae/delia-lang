...
public class PostgresDBExecutor extends ServiceBase implements DBExecutor {

    private final PostgresDBInterfaceFactory dbInterface;
    ...
    public PostgresDBExecutor(FactoryService factorySvc, DeliaLog sqlLog, PostgresDBInterfaceFactory dbInterface, DBConnection conn,

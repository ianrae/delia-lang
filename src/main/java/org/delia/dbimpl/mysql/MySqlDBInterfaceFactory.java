...
public class MySqlDBInterfaceFactory extends ServiceBase implements DBInterfaceFactory, DBInterfaceFactoryInternal {
    ...
    public MySqlDBInterfaceFactory(FactoryService factorySvc, ConnectionFactory connFactory) {
        super(factorySvc);
        this.capabilities = new DBCapabilties(true, true, true, true, "public");
        this.sqlLog = new SimpleLog();
        this.connFactory = connFactory;
        this.errorConverter = new MySqlErrorConverter(); //new SimpleSqlNameFormatter(null,true));
    ...
    public DBConnection openConnection() {
        MySqlDBConnection conn = new MySqlDBConnection(factorySvc, connFactory, errorConverter);
        conn.openDB();
        return conn;
    }
    ...
    public DBExecutor createExecutor() {
        DBConnection conn = (MySqlDBConnection) openConnection();
    ...
    public DBExecutor createExecutorEx(DBConnection conn) {
        ...
        DBExecutor exec = new MySqlDBExecutor(factorySvc, sqlLog, this, conn, fkResolver, errorConverter);

...
public class MySqlDBConnection extends H2DBConnection {

	public MySqlDBConnection(FactoryService factorySvc, ConnectionFactory connectionFactory, DBErrorConverter errorConverter) {
		super(factorySvc, connectionFactory, errorConverter);
		this.valueHelper = new MySqlValueHelper(factorySvc);
	}
...
//		return new PostgresValueHelper(factorySvc);
//	}
}
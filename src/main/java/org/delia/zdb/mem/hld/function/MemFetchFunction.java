...
public class MemFetchFunction extends MemFunctionBase {
	...
	private RelationFetchHelper relationFetchHelper;

	public MemFetchFunction(DTypeRegistry registry, FetchRunner fetchRunner, boolean doRFetch) {
		super(registry);
		this.fetchRunner = fetchRunner;
		this.doRFetch = doRFetch;
		this.relationFetchHelper = new RelationFetchHelper(registry, fetchRunner);
	}
...
//				continue;
				...
				if (relationFetchHelper.fetchParentSide(dval, targetFieldName)) {
					continue;
				}
			}

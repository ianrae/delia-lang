 ...
 *
 */
public class IsDateOnlyTests extends DeliaRunnerTestBase {
    ...
    public void test2() {
        ...
        String src = "  insert Flight {id: 55, name:'bob', birthDate: '2017-01-01T09:30:10' }\n";
        String src2 = " let x = Flight[true]";
        ErrorTracker localET = new SimpleErrorTracker(delia.getLog());
        AST.DeliaScript script = deliaRunner.compile(src+src2, localET);
        assertEquals(0, localET.errorCount());
        ...
        assertEquals(1, list.size());
        DValue inner = list.get(0).asStruct().getField("birthDate");
        assertEquals("2017-01-01T09:30:10.000+0000", inner.asString());
    }
    ...
    private DeliaSession initSession(DeliaRunnerImpl deliaRunner) {
        ...
        String src2 = "type Flight struct {id int primaryKey, name string, birthDate date } birthDate.isDateOnly() end";

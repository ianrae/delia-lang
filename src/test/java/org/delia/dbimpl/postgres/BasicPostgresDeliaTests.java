...
public class BasicPostgresDeliaTests extends TestBase {
...
//        DeliaStatementBuilder.autoAddPersonType = false;
//    }
    ...
    private DeliaSession runDelia(String src, boolean expected) {
        ConnectionDefinition connDef = PostgresConnectionHelper.getTestDB();

...
public class HLSSQL1NOtherWayTests extends HLSTestBase {
	...
	public void testOneSpanSubSQL() {
		...
		sqlchk("let x = Customer[true].fetch('addr').orderBy('id')", "SELECT a.cid,a.x,a.addr,b.id as addr,b.y FROM Customer as a LEFT JOIN Address as b ON a.addr=b.id ORDER BY a.id");

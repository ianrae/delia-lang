...
public class HLSSQL11Tests extends HLSTestBase {
	...
	public void testOneSpanSubSQL() {
		...
		sqlchk("let x = Customer[true].fetch('addr').orderBy('cid')", "SELECT a.cid,a.x,b.id,b.y,b.cust FROM Customer as a LEFT JOIN Address as b ON a.id=b.cust ORDER BY a.cid");

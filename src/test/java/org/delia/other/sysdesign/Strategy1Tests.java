...
public class Strategy1Tests {
	...
	public static class Product {
		...
		private boolean hasShippingTax;
		...
		public boolean isHasShippingTax() {
			return hasShippingTax;
		}
		public void setHasShippingTax(boolean hasShippingTax) {
			this.hasShippingTax = hasShippingTax;
		}
	}
	...
	public class OrderService {
		...
		private double getShippingTax(Product prod, Region region) {
			...
			case QUEBEC:
			case CANADA_OTHER:
				return prod.isHasShippingTax() ? 0.50 : 0.0;
			case TEXAS:
			case USA_OTHER:
			default:
				return 0.0;
	...
	public void test() {
		...
		assertEquals(17.6, total, 0.0001);
	}

...
public class AllBDDTests extends BDDTestBase {
    ...
    public void testR500() {
        ...
        //TODO: add test with 2 different MM (eg Customer.addr and Customer.profile Address and Profile)
        runR500File("t0-some-ad-hoc-tests.txt", 3);
    }
    ...
    public void testR560() {
        ...
        //runR500File("t0-relation-two.txt", 1); //TODO fix
    }
...
//
    ...
    public void testR950() {
        ...
        //TODO: add bdd test for 1:1 and 1:N crud actions
    }
...
//    }
    ...
    public void testR1200() {
        ...
        runR1200File("t0-let-scalar-dollar-dollar.txt", 2);
    }
    ...
    public void testR1500() {
        ...
        runR1500File("t0-queryfn-orderby-relation.txt", 1); //TODO only works with MEM. add support for POSTGRES
